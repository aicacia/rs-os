...
use crate::{
  ...
  router::{
    client::{
      constants::TAG,
      entity::{
        Client, ClientAllowed, ClientAuthorization, ClientAuthorizeRequest, ClientUpsertRequest,
        client_upsert_request_changed,
      },
    },
...
use os_model::entities::{
  clients::{deactivate_client, get_client_by_client_id, list_clients, upsert_client},
  users::{get_user_client_by_client_id, upsert_user_client},
};
