...
|------------- | ------------- | -------------|
| [**createUserHandler**](UserApi.md#createuserhandler) | **POST** /oidc/api/users |  |
| [**deleteUserHandler**](UserApi.md#deleteuserhandler) | **DELETE** /oidc/api/users/{id} |  |
| [**getUser**](UserApi.md#getuser) | **GET** /oidc/api/users/{id} |  |
| [**updateUserHandler**](UserApi.md#updateuserhandler) | **PUT** /oidc/api/users/{id} |  |
| [**userList**](UserApi.md#userlist) | **GET** /oidc/api/users |  |
