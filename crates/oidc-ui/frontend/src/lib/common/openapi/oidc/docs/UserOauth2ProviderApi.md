...
|------------- | ------------- | -------------|
| [**getUserOauth2Provider**](UserOauth2ProviderApi.md#getuseroauth2provider) | **GET** /oidc/api/users/{user_id}/oauth2-providers/{provider_id} |  |
| [**linkUserOauth2ProviderHandler**](UserOauth2ProviderApi.md#linkuseroauth2providerhandler) | **POST** /oidc/api/users/{user_id}/oauth2-providers |  |
| [**listUserOauth2Providers**](UserOauth2ProviderApi.md#listuseroauth2providers) | **GET** /oidc/api/users/{user_id}/oauth2-providers |  |
| [**unlinkUserOauth2ProviderHandler**](UserOauth2ProviderApi.md#unlinkuseroauth2providerhandler) | **DELETE** /oidc/api/users/{user_id}/oauth2-providers/{provider_id} |  |
