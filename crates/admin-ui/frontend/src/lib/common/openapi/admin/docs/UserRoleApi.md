...
|------------- | ------------- | -------------|
| [**assignUserRoleHandler**](UserRoleApi.md#assignuserrolehandler) | **POST** /admin/api/users/{user_id}/roles |  |
| [**listUserPermissions**](UserRoleApi.md#listuserpermissions) | **GET** /admin/api/users/{user_id}/permissions |  |
| [**listUserRoles**](UserRoleApi.md#listuserroles) | **GET** /admin/api/users/{user_id}/roles |  |
| [**removeUserRoleHandler**](UserRoleApi.md#removeuserrolehandler) | **DELETE** /admin/api/users/{user_id}/roles/{role_id} |  |
