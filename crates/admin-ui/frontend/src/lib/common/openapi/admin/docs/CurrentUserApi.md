...
|------------- | ------------- | -------------|
| [**currentUser**](CurrentUserApi.md#currentuser) | **GET** /admin/api/current-user |  |
| [**updatePassword**](CurrentUserApi.md#updatepassword) | **PATCH** /admin/api/current-user/password |  |
| [**updateUserInfo**](CurrentUserApi.md#updateuserinfooperation) | **PATCH** /admin/api/current-user/info |  |
| [**updateUsername**](CurrentUserApi.md#updateusernameoperation) | **PATCH** /admin/api/current-user |  |
