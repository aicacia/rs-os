...
|------------- | ------------- | -------------|
| [**createUserEmailHandler**](UserEmailApi.md#createuseremailhandler) | **POST** /admin/api/users/{user_id}/emails |  |
| [**deleteUserEmailHandler**](UserEmailApi.md#deleteuseremailhandler) | **DELETE** /admin/api/users/{user_id}/emails/{email_id} |  |
| [**getUserEmail**](UserEmailApi.md#getuseremail) | **GET** /admin/api/users/{user_id}/emails/{email_id} |  |
| [**listUserEmails**](UserEmailApi.md#listuseremails) | **GET** /admin/api/users/{user_id}/emails |  |
| [**updateUserEmailHandler**](UserEmailApi.md#updateuseremailhandler) | **PATCH** /admin/api/users/{user_id}/emails/{email_id} |  |
| [**verifyUserEmailHandler**](UserEmailApi.md#verifyuseremailhandler) | **POST** /admin/api/users/{user_id}/emails/{email_id}/verify |  |
