...
|------------- | ------------- | -------------|
| [**createUserHandler**](UserApi.md#createuserhandler) | **POST** /admin/api/users |  |
| [**deleteUserHandler**](UserApi.md#deleteuserhandler) | **DELETE** /admin/api/users/{id} |  |
| [**getUser**](UserApi.md#getuser) | **GET** /admin/api/users/{id} |  |
| [**updateUserHandler**](UserApi.md#updateuserhandler) | **PUT** /admin/api/users/{id} |  |
| [**userList**](UserApi.md#userlist) | **GET** /admin/api/users |  |
