...
import type { Health, Version } from '../models/index';
import { HealthFromJSON, HealthToJSON, VersionFromJSON, VersionToJSON } from '../models/index';
...
export class UtilApi extends runtime.BaseAPI implements UtilApiInterface {
	...
	async healthRaw(
		...
		let urlPath = `/oidc-admin/api/health`;
	...
	async versionRaw(
		...
		let urlPath = `/oidc-admin/api/version`;
